...
@MainActor
public protocol SimRadioMediaState: AnyObject, Sendable {
...
public struct SimRadioStationData {
    public let station: SimStation
...
public extension SimRadioMediaState {
