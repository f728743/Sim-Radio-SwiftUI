...
@MainActor
public final class DefaultSimRadioLibrary {
    ...
    public weak var delegate: SimRadioLibraryDelegate?
...
extension DefaultSimRadioLibrary: SimRadioLibrary {
    public func downloadStation(_ stationID: SimStation.ID) async {
    ...
    public func removeDownload(_ stationID: SimStation.ID) async {
    ...
    public func pauseDownload(_ stationID: SimStation.ID) async {
        guard let mediaState,
              let state = mediaState.simDownloadStatus[stationID]?.state
        else { return }
    ...
    public func remove(_ series: SimGameSeries) async throws {
